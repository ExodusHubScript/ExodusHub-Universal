...
--  Build  : 2026.04.16.7  (LOADSTRING-SAFE)
--  Notes  : everything wrapped in pcall, all locals inside scope
--           so loadstring(...)() runs clean. keyless.
-- ════════════════════════════════════════════════════════════════

local function __exodusMain()
    ...
    rightPanel.Size = UDim2.new(1, -184, 1, 0)
    rightPanel.Position = UDim2.new(0, 184, 0, 0)
    rightPanel.BackgroundTransparency = 1

    local mono = Instance.new("TextLabel", rightPanel)
    mono.Size = UDim2.new(0, 56, 0, 56)
    mono.Position = UDim2.new(0, 18, 0, 20)
    ...
    rTitle.Position = UDim2.new(0, 86, 0, 24)
    ...
    rTag.Position = UDim2.new(0, 86, 0, 52)
    ...
    rStatus.Size = UDim2.new(1, -36, 0, 16)
    rStatus.Position = UDim2.new(0, 18, 0, 110)
    ...
    rTrack.Size = UDim2.new(1, -36, 0, 5)
    rTrack.Position = UDim2.new(0, 18, 0, 138)
    ...
    rPct.Size = UDim2.new(1, -36, 0, 16)
    rPct.Position = UDim2.new(0, 18, 0, 152)
    ...
    for i = 1, #STEPS do
        ...
        local pct = i / #STEPS
        TweenService:Create(rFill, TweenInfo.new(0.25, Enum.EasingStyle.Quad), {
    ...
    local function setPage(name)
        ...
        for n, btn in pairs(tabBtns) do
            ...
            if ico then ico.TextColor3 = on and C.accent or C.dim end
    ...
    local function pillRow(pg, label, default, cb)
        ...
        local pb = Instance.new("Frame", row)
        pb.Size = UDim2.new(0,36,0,20)
        pb.Position = UDim2.new(1,-44,0.5,-10)
        pb.BackgroundColor3 = default and C.on or C.off
        pb.BorderSizePixel = 0
        Instance.new("UICorner", pb).CornerRadius = UDim.new(1,0)

        local dot = Instance.new("Frame", pb)
